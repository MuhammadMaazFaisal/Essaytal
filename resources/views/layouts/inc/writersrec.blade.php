    ...
    <div class="dashboard_wrap">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 mb-4">
                <h6 class="m-0">All Writers List</h6>
            </div>
        </div>
                    ...
                    <table class="table dash_list">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th scope="row">{{$writerlist->id}}</th>
                                <td><img src="https://via.placeholder.com/500x500" class="img-fluid circle" width="40" alt="" /></td>
                                <td><div class="smalls lg">{{$writerlist->name}}</div></td>
                                <td><span class="smalls lg">{{$writerlist->email}}</span></td>
                                <td><span class="smalls lg">{{$writerlist->created_at}}</span></td>
                                <td>
                                    <div class="dropdown show">
                                        ...
                                        <div class="drp-select dropdown-menu">
                                            <a class="dropdown-item" href="/edit/{{$writerlist->id}}">Edit</a>
                                            <a class="dropdown-item" href="/delete/{{$writerlist->id}}">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
